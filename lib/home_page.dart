...
// Catatan: 'auth_provider.dart' dan 'providers.dart' tidak lagi diperlukan di file ini.
            ...
            onSelected: (value) {
              if (value == 'logout') {
                ...
                showAboutDialog(
                  ...
                  children: [
                    const Text('Aplikasi ini dibuat untuk memenuhi tugas mata kuliah Pemrograman Mobile.'),
                  ]
                );
              }
            },
